...
return (function (p__8169){
var vec__8170 = p__8169;
var attr = cljs.core.nth.call(null,vec__8170,(0),null);
var v = cljs.core.nth.call(null,vec__8170,(1),null);
...
var args8173 = [];
var len__7652__auto___8176 = arguments.length;
var i__7653__auto___8177 = (0);
while(true){
if((i__7653__auto___8177 < len__7652__auto___8176)){
args8173.push((arguments[i__7653__auto___8177]));

var G__8178 = (i__7653__auto___8177 + (1));
i__7653__auto___8177 = G__8178;
continue;
} else {
}
break;
...
var len__7652__auto___8181 = arguments.length;
var i__7653__auto___8182 = (0);
while(true){
if((i__7653__auto___8182 < len__7652__auto___8181)){
args__7659__auto__.push((arguments[i__7653__auto___8182]));

var G__8183 = (i__7653__auto___8182 + (1));
i__7653__auto___8182 = G__8183;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq8180){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8180));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__8184){
var map__8188 = p__8184;
...
var data = map__8188__$1;
var message = cljs.core.get.call(null,map__8188__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__8188__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__8188__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__8190 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__8190,goog.events.EventType.CLICK,((function (G__8190,map__8188,map__8188__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__8190,map__8188,map__8188__$1,data,message,line,file))
);

return G__8190;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__8191){
var map__8195 = p__8191;
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__8198){
var map__8202 = p__8198;
var map__8202__$1 = ((((!((map__8202 == null)))?((((map__8202.cljs$lang$protocol_mask$partition0$ & (64))) || (map__8202.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8202):map__8202);
var messages = map__8202__$1;
var warnings = cljs.core.get.call(null,map__8202__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8202__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__8204 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__8204,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.constHtmlToNode(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__8204,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__8205){
var map__8208 = p__8205;
...
var messages = map__8208__$1;
var warnings = cljs.core.get.call(null,map__8208__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8208__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__8208,map__8208__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__8208,map__8208__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__8208,map__8208__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__8208,map__8208__$1,messages,warnings,exception))
;
...
}catch (e8211){if((e8211 instanceof Error)){
var __8212 = e8211;
} else {
throw e8211;
