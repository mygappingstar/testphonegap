...
var x__7240__auto__ = (((x == null))?null:x);
var m__7241__auto__ = (sablono.util.to_str[goog.typeOf(x__7240__auto__)]);
if(!((m__7241__auto__ == null))){
return m__7241__auto__.call(null,x);
} else {
var m__7241__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__7241__auto____$1 == null))){
return m__7241__auto____$1.call(null,x);
} else {
...
var x__7240__auto__ = (((x == null))?null:x);
var m__7241__auto__ = (sablono.util.to_uri[goog.typeOf(x__7240__auto__)]);
if(!((m__7241__auto__ == null))){
return m__7241__auto__.call(null,x);
} else {
var m__7241__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__7241__auto____$1 == null))){
return m__7241__auto____$1.call(null,x);
} else {
...
var len__7652__auto___9793 = arguments.length;
var i__7653__auto___9794 = (0);
while(true){
if((i__7653__auto___9794 < len__7652__auto___9793)){
args__7659__auto__.push((arguments[i__7653__auto___9794]));

var G__9795 = (i__7653__auto___9794 + (1));
i__7653__auto___9794 = G__9795;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__7660__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq9792){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9792));
});
...
var vec__9799 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__9801;
var words = seq__9800__$1;
...
var G__9803 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__9803,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__9803;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__9804_SHARP_){
if(typeof p1__9804_SHARP_ === 'string'){
return p1__9804_SHARP_;
} else {
return cljs.core.seq.call(null,p1__9804_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__6577__auto__ = x__$1.hasDomain();
