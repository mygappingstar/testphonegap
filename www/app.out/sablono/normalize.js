...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__9807_SHARP_){
return ((p1__9807_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__9807_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__9809,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__9809;
}
});
...
var len__7652__auto___9812 = arguments.length;
var i__7653__auto___9813 = (0);
while(true){
if((i__7653__auto___9813 < len__7652__auto___9812)){
args__7659__auto__.push((arguments[i__7653__auto___9813]));

var G__9814 = (i__7653__auto___9813 + (1));
i__7653__auto___9813 = G__9814;
continue;
} else {
}
break;
...
var G__9811 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__9811,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__9811;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq9810){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9810));
});
...
var vec__9820 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__9820,(0),null);
var names = cljs.core.nth.call(null,vec__9820,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__9820,tag_name,names){
return (function (p1__9815_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__9815_SHARP_));
});})(matches,vec__9820,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__9820,tag_name,names){
return (function (p1__9816_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__9816_SHARP_));
});})(matches,vec__9820,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__9823){
var vec__9830 = p__9823;
...
var vec__9833 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__9833,(0),null);
var id = cljs.core.nth.call(null,vec__9833,(1),null);
var class$ = cljs.core.nth.call(null,vec__9833,(2),null);
