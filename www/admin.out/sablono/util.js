...
var len__7652__auto___9522 = arguments.length;
var i__7653__auto___9523 = (0);
while(true){
if((i__7653__auto___9523 < len__7652__auto___9522)){
args__7659__auto__.push((arguments[i__7653__auto___9523]));

var G__9524 = (i__7653__auto___9523 + (1));
i__7653__auto___9523 = G__9524;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq9521){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9521));
});
...
var vec__9528 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__9530;
var words = seq__9529__$1;
...
var G__9532 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__9532,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__9532;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__9533_SHARP_){
if(typeof p1__9533_SHARP_ === 'string'){
return p1__9533_SHARP_;
} else {
return cljs.core.seq.call(null,p1__9533_SHARP_);
