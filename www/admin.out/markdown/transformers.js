...
var G__8283 = cljs.core.into.call(null,buf,cljs.core.concat.call(null,cljs.core.seq.call(null,"<sup>"),cljs.core.second.call(null,remaining),cljs.core.seq.call(null,"</sup>")));
var G__8284 = cljs.core.drop.call(null,(2),remaining);
buf = G__8283;
remaining = G__8284;
continue;
} else {
var G__8285 = cljs.core.into.call(null,buf,cljs.core.first.call(null,remaining));
var G__8286 = cljs.core.rest.call(null,remaining);
buf = G__8285;
remaining = G__8286;
continue;
...
markdown.transformers.br = (function markdown$transformers$br(text,p__8287){
...
var state = map__8290__$1;
var code = cljs.core.get.call(null,map__8290__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var lists = cljs.core.get.call(null,map__8290__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_(new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(state))?text:clojure.string.replace.call(null,text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,(function (p1__8292_SHARP_){
var url = cljs.core.subs.call(null,p1__8292_SHARP_,(1),(cljs.core.count.call(null,p1__8292_SHARP_) - (1)));
...
})())?text:clojure.string.replace.call(null,text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__8293_SHARP_){
var encoded = (cljs.core.truth_(new cljs.core.Keyword(null,"clojurescript","clojurescript",-299769403).cljs$core$IFn$_invoke$arity$1(state))?cljs.core.subs.call(null,p1__8293_SHARP_,(1),(cljs.core.count.call(null,p1__8293_SHARP_) - (1))):cljs.core.apply.call(null,cljs.core.str,cljs.core.map.call(null,(function (c){
if((cljs.core.rand.call(null) > 0.5)){
return markdown.transformers.formatter.call(null,"&#x%02x;",(c | (0)));
} else {
return c;
}
}),cljs.core.subs.call(null,p1__8293_SHARP_,(1),(cljs.core.count.call(null,p1__8293_SHARP_) - (1))))));
return [cljs.core.str("<a href=\"mailto:"),cljs.core.str(encoded),cljs.core.str("\">"),cljs.core.str(encoded),cljs.core.str("</a>")].join('');
}))),state], null);
});
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__8294){
var map__8297 = p__8294;
...
var state = map__8297__$1;
var inline_heading = cljs.core.get.call(null,map__8297__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
...
markdown.transformers.paragraph = (function markdown$transformers$paragraph(text,p__8299){
...
var state = map__8302__$1;
var eof = cljs.core.get.call(null,map__8302__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var paragraph__$1 = cljs.core.get.call(null,map__8302__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
var blockquote = cljs.core.get.call(null,map__8302__$1,new cljs.core.Keyword(null,"blockquote","blockquote",372264190));
var heading = cljs.core.get.call(null,map__8302__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var hr = cljs.core.get.call(null,map__8302__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var temp = cljs.core.get.call(null,map__8302__$1,new cljs.core.Keyword(null,"temp","temp",1791541284));
var lists = cljs.core.get.call(null,map__8302__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var inline_heading = cljs.core.get.call(null,map__8302__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
var last_line_empty_QMARK_ = cljs.core.get.call(null,map__8302__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var code = cljs.core.get.call(null,map__8302__$1,new cljs.core.Keyword(null,"code","code",1586293142));
...
markdown.transformers.code = (function markdown$transformers$code(text,p__8304){
...
var state = map__8307__$1;
var eof = cljs.core.get.call(null,map__8307__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.call(null,map__8307__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var code__$1 = cljs.core.get.call(null,map__8307__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__8307__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
var vec__8312 = cljs.core.split_with.call(null,cljs.core.partial.call(null,cljs.core.not_EQ_," "),cljs.core.drop.call(null,(3),trimmed));
var lang = cljs.core.nth.call(null,vec__8312,(0),null);
var code = cljs.core.nth.call(null,vec__8312,(1),null);
...
markdown.transformers.blockquote = (function markdown$transformers$blockquote(text,p__8315){
...
var state = map__8318__$1;
var eof = cljs.core.get.call(null,map__8318__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var code = cljs.core.get.call(null,map__8318__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__8318__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var lists = cljs.core.get.call(null,map__8318__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim.call(null,text);
...
return [cljs.core.str("<ol class='footnotes'>"),cljs.core.str(p1__8320_SHARP_),cljs.core.str("</ol>")].join('');
}).call(null,cljs.core.reduce.call(null,(function (footnotes__$1,p__8325){
var vec__8326 = p__8325;
var id = cljs.core.nth.call(null,vec__8326,(0),null);
var label = cljs.core.nth.call(null,vec__8326,(1),null);
...
var vec__8335 = cljs.core.re_matches.call(null,/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.call(null,vec__8335,(0),null);
var key = cljs.core.nth.call(null,vec__8335,(1),null);
var val = cljs.core.nth.call(null,vec__8335,(2),null);
var vec__8338 = cljs.core.re_matches.call(null,/^    (.*)$/,line);
var ___$1 = cljs.core.nth.call(null,vec__8338,(0),null);
var next_val = cljs.core.nth.call(null,vec__8338,(1),null);
...
var vec__8344 = ((cljs.core.sequential_QMARK_.call(null,data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.call(null,vec__8344,(0),null);
var val = cljs.core.nth.call(null,vec__8344,(1),null);
...
var G__8347 = cljs.core.merge.call(null,acc,cljs.core.PersistentArrayMap.fromArray([key,new_val], true, false));
var G__8348 = cljs.core.rest.call(null,remain);
var G__8349 = key;
acc = G__8347;
remain = G__8348;
prev_key = G__8349;
