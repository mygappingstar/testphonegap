...
var G__15442 = atom;
cljs.core.add_watch.call(null,G__15442,new cljs.core.Keyword("alandipert.storage-atom","storage-watch","alandipert.storage-atom/storage-watch",1159565749),((function (G__15442,existing,debounce){
...
return cljs.core.not_EQ_.call(null,p3__15437_SHARP_,p4__15438_SHARP_);
} else {
return and__6565__auto__;
}
})())){
return debounce.call(null,((function (G__15442,existing,debounce){
return (function (){
return alandipert.storage_atom._commit_BANG_.call(null,backend,p4__15438_SHARP_);
});})(G__15442,existing,debounce))
...
var _STAR_watch_active_STAR_15446 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;

try{return cljs.core.reset_BANG_.call(null,atom,default$);
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_15446;
}} else {
...
var _STAR_watch_active_STAR_15448 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;
...
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_15448;
}} else {
return null;
}
} else {
...
return alandipert.storage_atom.maybe_update_backend.call(null,atom,storage,k,default$,p1__15449_SHARP_);
});})(default$))
);
});
/**
